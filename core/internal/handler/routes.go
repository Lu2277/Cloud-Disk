		...
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				},
				{
					Method:  http.MethodPost,
					Path:    "/share/record",
					Handler: ShareRecordHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/share/save",
				...
				{
					Method:  http.MethodPost,
					Path:    "/file/chuck/upload",
					Handler: FileChuckUploadHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/file/chuck/upload/complete",
					Handler: FileChuckUploadCompleteHandler(serverCtx),
				},
			}...,
		),
	)
